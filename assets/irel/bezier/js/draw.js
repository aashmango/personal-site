function bindDrawFunctions(idx) {
  ...
  return {
    ...
    drawSkeleton: function(curve, offset, nocoords) {
      ...
      ctx.strokeStyle = "#ED4267";
      if(!nocoords) this.drawPoints(pts, offset);
    },

      drawSkeleton2: function(curve, offset, nocoords) {
      offset = offset || { x:0, y:0 };
      var pts = curve.points;
      ...
      ctx.strokeStyle = "none";
      if(!nocoords) this.drawPoints2(pts, offset);
    },
    ...
    drawPoints: function(points, offset) {
      ...
      points.forEach(function(p) {
        this.drawCircle(p, 6, offset);
      }.bind(this));
    },

     drawPoints2: function(points, offset) {
      offset = offset || { x:0, y:0 };
      points.forEach(function(p) {
